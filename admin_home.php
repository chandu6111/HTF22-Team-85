        ...
        <?php
            ...
            if(mysqli_num_rows($query1)!=0){
                ...
                <div class='card clean-card text-center'><img class='card-img-top w-100 d-block' src='logos/$opid.jpg'>
                    ...
                    </div><button class='btn btn-primary overlay' type='button' style='color: var(--bs-black);font-family: ABeeZee, sans-serif;background: var(--bs-yellow);margin-top:98px;'><i class='fa fa-pen'></i>&nbsp;<a href='editform.php' style='text-decoration: none;color:black;'>Edit</a></button>
                    </div>
                </div>
                    ";
                }
